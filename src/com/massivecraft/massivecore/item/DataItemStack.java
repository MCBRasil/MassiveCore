...
public class DataItemStack implements Comparable<DataItemStack>
{
	...
	public static final transient Map<Integer, DataItemStack> DEFAULT_BLOCK_STATE_INVENTORY = Collections.emptyMap();
	...
	@EditorVisible(false)
	private Map<Integer, DataItemStack> blockStateInventory = null;
	public Map<Integer, DataItemStack> getBlockStateInventory() { return get(this.blockStateInventory, DEFAULT_BLOCK_STATE_INVENTORY); }
	public DataItemStack setBlockStateInventory(Map<Integer, DataItemStack> blockStateInventory) { this.blockStateInventory = set(blockStateInventory, DEFAULT_BLOCK_STATE_INVENTORY); return this; }
	...
	public static ItemStack[] toBukkitContents(Map<Integer, DataItemStack> contents)
	{
		...
		{
			DataItemStack item = contents.get(integer);
			ret[integer] = item.toBukkit();
		}
	...
	public int compareTo(DataItemStack that)
	{
		return ComparatorSmart.get().compare(
			...
			this.getBlockStateInventory(), that.getBlockStateInventory()
		);
	}
